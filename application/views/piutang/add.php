...
<div class="py-4">
  <div class="container">
    <div class="row">
      <div class="col-md-7">
        <form id="c_form-h" method="post" action="<?= base_url('Piutang/create'); ?>" enctype="multipart/form-data">
        <div class="form-group row">
          <label for="tanggal_piutang" class="col-4 col-form-label">Tanggal*</label>
          <div class="col-9">
            <input type="text" class="form-control" name="tanggal_piutang"> 
          </div>
        </div>
        <div class="form-group row">
